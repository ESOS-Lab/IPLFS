...
# FILESYSTEM=(NORMAL_new)
#FILESYSTEM=(tight_discard_noprintk)
# FILESYSTEM=(discard_tight)
# FILESYSTEM=(NORMAL_print_1st_FGGC)
# FILESYSTEM=(pure_NORMAL)
#FILESYSTEM=(ZONE)
# FILESYSTEM=(ZONE_debug)
#FILESYSTEM=(DSCD_TEST)
# FILESYSTEM=(agg_discard)
# FILESYSTEM=(ms_thesis_discard_20)
FILESYSTEM=(IPLFS)
# FILESYSTEM=(ms_thesis_discard_320)
# FILESYSTEM=(artifact)
# FILESYSTEM=(1500_800)
# FILESYSTEM=(NORMAL)
# FILESYSTEM=(NORMAL_11)
# FILESYSTEM=(NORMAL_11_fggc)
IO_TYPE=(randwrite)
